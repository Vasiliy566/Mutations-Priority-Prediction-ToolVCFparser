...
public class Examples {
	...
	//	PriorityValueCountRule prediction_4 = new PriorityValueCountRule("dbNSFP_SIFT_pred", 'e', 'D', 0.5);
		...
		PriorityValueCountRule annotation_5 = new PriorityValueCountRule("ANN", 's', "+2", 0.5);
		PriorityValueCountRule annotation_6 = new PriorityValueCountRule("ANN", 's', "+3", 0.5);
		PriorityValueCountRule annotation_7 = new PriorityValueCountRule("ANN", 's', "-1", 0.5);
		PriorityValueCountRule annotation_8 = new PriorityValueCountRule("ANN", 's', "-2", 0.5);
		PriorityValueCountRule annotation_9 = new PriorityValueCountRule("ANN", 's', "-3", 0.5);
		*/
