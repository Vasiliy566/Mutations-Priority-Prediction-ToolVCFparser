...
/**
 * Class information parameter in VCF-files format <b>ID</b> , <b>number</b> ,
...
public class InformationParameter {
	...
	/**
	 * Parameter's ID example: NS meaning: "NS"(Number of Samples With Data) ; "DP"
	 * (Total Depth), etc most popular is 2 chars for ID But can be much more:
	 * ##INFO=<ID=VQSLOD,Number=1,Type=Float,Description="Lo"
	 */
	private String ID;
	...
	/**
	 * Data type example: String meaning: Type of included data
	 */
	private String type;

	/**
	 * Description of parameter example: "Total Depth" meaning: Description this
	 * parameter's meaning
	 */
	...
	/**
	 * <br />
	 * <b>Constructor: make new object from list by string from VCF-file</b> <br />
	 * <b>Usage: to parse VCF-files</b>
	 * 
